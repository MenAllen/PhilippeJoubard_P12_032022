		...
		<div className="activityChartContainer">
			...
			<ResponsiveContainer width="100%" height="100%">
				<BarChart
					...
					<Legend verticalAlign="top" height={60} align="right" iconType="circle" iconSize="10" formatter={(value, entry, index) => <span className="activityLegendColor">{value}</span>} />
					<Bar name={"Poids (kg)"} yAxisId="right" dataKey="kilogram" fill="#282D30" barSize={8} radius={[5, 5, 0, 0]} />
					<Bar name={"Calories brûlées (Kcal)"} yAxisId="left" dataKey="calories" fill="#E60000" barSize={8} radius={[5, 5, 0, 0]} />
				</BarChart>
			</ResponsiveContainer>
		</div>
	);
